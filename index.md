...
3. Rui Zhang#, **Yixin Su**#*, Bayu Distiawan Trisedya, Xiaoyan Zhao, Min Yang, Hong Cheng, Jianzhong Qi, AutoAlign: Fully Automatic and Effective Knowledge Graph Alignment enabled by Large Language Models. _IEEE Transactions on Knowledge and Data Engineering (TKDE) 2024_. [paper](https://arxiv.org/pdf/2307.11772) [code](https://github.com/ruizhang-ai/AutoAlign) (**Co-first Author, Corresponding Author, CCF-A**)
...
7. Yuchao Ma, Ruohan Qian, Bingzhe Wang, Qi Qi, Wenqiang liu, Qian Tang, Zhao Shen, Wei Zhong, Bo Shen, **Yixin Su**, Bin Zou, Wen Yi, Zhi Guo, shuanglong li, Liu Lin, GenAuction: A Generative Auction for Online Advertising. _Annual AAAI Conference on Artificial Intelligence (AAAI) 2025_ (**CCF-A**)
8. Yunxiang Zhao, Jianzhong Qi, Bayu D Trisedya, **Yixin Su**, Rui Zhang, Hongguang Re*n, Learning Region Similarities via Graph-based Deep Metric Learning. _IEEE Transactions on Knowledge and Data Engineering (TKDE) 2023_. (**CCF-A**)
9. Xinxin Su; Zhen Huang; **Yixin Su**; Bayu Distiawan Trisedya; Yong Dou; Yunxiang Zhao, Hierarchical Shared Encoder With Task-Specific Transformer Layer Selection for Emotion-Cause Pair Extraction, _IEEE Transactions on Affective Computing (TAC) 2024_ [paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=10504556) (**CCF-B**)
10. Ziqiang Cui#, **Yixin Su**#, Fangquan Lin, Cheng Yang, Hanwei Zhang, Jihai, Zhang, Dual Disentangled Attention for Multi-Information Utilization in Sequential Recommendation. _International Joint Conference on Neural Networks (IJCNN) 2022_. (**Co-first Author**)
